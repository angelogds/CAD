...
exports.limparHorasExtrasTeste = (req, res) => { try { const r = service.limparHorasExtrasTeste(currentUser(req)); flashSuccess(req, `${r.total} lançamento(s) de hora extra apagado(s). Banco de horas recalculado.`); } catch(e){ flashError(req, e.message); } return redirectBack(req, res, '/escala/hora-extra/pendentes'); };
