...
test('busca lexical favorece conteúdo com termos da consulta', () => {
  assert.ok(lexicalScore('rolamento prensa p50', 'Troca do rolamento principal da Prensa P50.') > lexicalScore('rolamento prensa p50', 'Procedimento de soldagem TIG da caldeira.'));
});
