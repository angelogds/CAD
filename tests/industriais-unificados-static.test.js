...
test('seed anual 2026 roda rodízio noturno com os seis mecânicos industriais e sem coluna de apoio', () => {
  ...
  for (const nome of ['Diogo', 'Salviano', 'Rodolfo', 'Emanuel', 'Luiz', 'Júnior']) {
...
test('preventivas comunicam equipe padrão como mecânicos industriais', () => {
  ...
  assert.match(controller, /Equipe padrão: Júnior e Luiz — Mecânicos Industriais/);
  assert.match(service, /Júnior e Luiz — Mecânicos Industriais/);
});
